...
## Data We Collect
- Contact and account information you provide (e.g., GitHub handle, email)
- Diagnostic logs and telemetry (if you opt-in)
- Security reports and communications

## Purpose and Legal Basis
- Provide and improve the Software (legitimate interests)
- Security and abuse prevention (legitimate interests)
- Legal compliance

## Sharing
We do not sell personal data. We share with vendors under contract and as required by law.

## International Transfers
Data may be processed outside India. Where required, we use appropriate safeguards.
...
Contact: privacy@sitaramtech.in
...
## Changes
We may update this Policy; material changes will be highlighted in the repo.
